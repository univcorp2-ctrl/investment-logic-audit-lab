...
| `src/investment_audit/signals.py` | 時系列モメンタム、移動平均、クロスセクション、ファンダメンタル |
...
| `src/investment_audit/sec_companyfacts.py` | SEC Company Facts APIクライアント |
...
- パラメータ近傍の安定性を重視するrobust objectiveを追加
