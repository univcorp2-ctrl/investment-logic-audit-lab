...
const staticFiles = [
  ...
  'fundamental-lab.js','fundamental-lab-core.js','fundamental-lab.css',
...
for (const marker of [
  ...
  '<link rel="stylesheet" href="./fundamental-lab.css" />',
...
for (const marker of [
  ...
  '<script type="module" src="./fundamental-lab.js"></script>',
